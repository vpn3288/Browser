...
<#
.SYNOPSIS
    Multi-Browser Anti-Detect Optimization Tool v14.6
.DESCRIPTION
...
.NOTES
    ...
    Version: 14.6 - 修复语法错误、补全WebRTC、恢复中文：删除启动器、修正策略名、清理冗余
...
# ===== 配置区域 =====
$languageConfig = @{
    "Chrome" = "zh-CN,zh,en-US,en"
    "Edge" = "zh-CN,zh,en-US,en"
    "Brave" = "zh-TW,zh,en-US,en"
    "Opera" = "zh-TW,zh,en-US,en"
    "Vivaldi" = "zh-CN,zh,en-US,en"
    "Chromium" = "zh-TW,zh,en-US,en"
    "Firefox" = "zh-CN,zh,en-US,en"
    "LibreWolf" = "zh-TW,zh,en-US,en"
    "Zen Browser" = "en-US"  # v14.6: 全部使用en-US（正常美国人）
}
...
function Set-ChromiumAdvancedConfig {
    ...
    $policies = @{
        ...
        # 反检测核心
        # v14.6: 删除 - 虚假优化，暴露浏览器被修改
        # v14.6: 删除 - 虚假优化，暴露浏览器被修改
        # v14.6: WebRTC策略 - Edge使用专用策略名
    ...
    # v14.6: 删除 - 已禁用拼写检查，此项冗余
    
    # WebRTC IP防护（v14.6: 补全所有Chromium系）
    ...
    if ($BrowserKey -eq "Edge") {
        ...
        $policies["WebRtcLocalhostIpHandling"] = "disable_non_proxied_udp"  # v14.6: Edge专用WebRTC策略
    }
    ...
    if ($BrowserKey -eq "Chrome") {
        ...
        $policies["EnableMediaRouter"] = 0  # v14.6: 修正语法
        # v14.6: 删除 - 虚假优化（服务已关闭）
...
Write-Host "  多浏览器反检测优化工具 v14.6" -ForegroundColor Green
